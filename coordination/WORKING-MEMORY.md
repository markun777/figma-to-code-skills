...
- current active issue: [#13](https://github.com/markun777/figma-to-code-skills/issues/13) — permanent coordination log, never close
...
| BookmarkBar | closed (2026-05-22) | PR #30 merged; full bar 1708:30228; divider + BookmarkItem(s) + More button; 3 assets exported; inline-flex root |
...
- Phase N — BookmarkBar: **closed** (2026-05-22).
